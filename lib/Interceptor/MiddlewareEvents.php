...
namespace ScoreAsAService\Client\Interceptor;
...
use \ScoreAsAService\Client\Interceptor\MyLogger;
use \ScoreAsAService\Client\Model\Errors;
use \ScoreAsAService\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(\ScoreAsAService\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new \ScoreAsAService\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new \ScoreAsAService\Client\Model\Errores(["errors" => [$error]]);
